...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "The fourth version of my portfolio, featuring recent projects with more mature designs.",
    technologies: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Shadcn/UI", "Vercel"],
    liveLink: "https://aldipratama-portfoliov4.vercel.app/",
    longDescription: "This portfolio is the most up-to-date version that represents my current capabilities. It adopts Shadcn/UI for beautiful and accessible UI components, and is built on a solid foundation of Next.js and TypeScript. This project is the ultimate showcase of my frontend development skills.",
    features: [
      "UI component with Shadcn/UI",
      "Professional Layout",
      "Detailed Project Description",
      "Blog or Article Page (optional)",
    ],
    category: "Portfolio",
  },
  {
